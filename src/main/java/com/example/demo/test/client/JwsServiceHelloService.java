 ...
 * 
 */
@WebServiceClient(name = "JwsServiceHelloService", targetNamespace = "http://service.test.demo.example.com/", wsdlLocation = "http://127.0.0.1:8080/WebServiceTest?wsdl")
    ...
    extends Service
{
    ...
    private final static QName JWSSERVICEHELLOSERVICE_QNAME = new QName("http://service.test.demo.example.com/", "JwsServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/WebServiceTest?wsdl");
    ...
    public JwsServiceHello getJwsServiceHelloPort() {
        return super.getPort(new QName("http://service.test.demo.example.com/", "JwsServiceHelloPort"), JwsServiceHello.class);
    }
    ...
    public JwsServiceHello getJwsServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.test.demo.example.com/", "JwsServiceHelloPort"), JwsServiceHello.class, features);
    }
